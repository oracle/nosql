 ...
 * disable optimizations in JE 6 that drastically reduce cleaner costs. In
 * addition, using a partial comparator for a secondary DB will optimizations
 * in JE 20.1 involving "blind" deletions.
 * <p>
