...
public class BinaryNodeStateService extends ExecutingService {
    ...
    class NodeStateServiceRunnable implements Runnable {
        ...
        private BinaryNodeStateResponse createResponse
            ...
            long joinTime = repNode.getJoinTimeMs();
            long txnEndVLSN = (repNode.getCurrentTxnEndVLSN() == INVALID_VLSN ?
                    0L : repNode.getCurrentTxnEndVLSN());
        ...
        public void run() {
            ...
            try {
                protocol = new BinaryNodeStateProtocol(channel,
                    repNode.getRepImpl());
                try {
