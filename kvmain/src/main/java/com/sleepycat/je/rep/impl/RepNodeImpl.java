...
public class RepNodeImpl implements ReplicationNode, Serializable {
    ...
    public boolean isRemovedNoCheck() {
        return isRemoved;
    }
    ...
    /**
     * Set the node type, note this does not perform any valid checks, such as
     * checking if the new type is transient and the node is marked as
     * removed.
     */
    ...
    public String toString() {
        ...
        String info =
            String.format("Node:%s %s:%d%s%s changeVersion:%d %s id:%d\n",
     ...
     * and the isRemoved, changeVersion, and jeVersion fields (which can
     * change over time).
     *
    ...
    public boolean equivalent(RepNodeImpl mi) {
        ...
        /* Ignore quorumAck, isRemoved, changeVersion, and jeVersion */
