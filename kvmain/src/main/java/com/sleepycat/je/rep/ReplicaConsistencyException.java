...
public class ReplicaConsistencyException extends OperationFailureException {
    ...
    private final transient ReplicaConsistencyPolicy consistencyPolicy;
    ...
    public OperationFailureException wrapSelf(
        ...
        return new ReplicaConsistencyException(
            msg, (ReplicaConsistencyException) clonedCause);
    }
