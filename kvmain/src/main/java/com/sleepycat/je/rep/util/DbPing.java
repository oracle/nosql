...
public class DbPing {
     ...
     * @param groupName name of the group which the node joins
     * @param socketAddress address of the node
     * @param socketTimeout timeout value for creating a socket connection
     * with the node
     * @param netConfig a replication-net configuration object
     * property settings.  Null is allowed.
     ...
     * settings.
     */
    public DbPing(String nodeName,
                  String groupName,
                  InetSocketAddress socketAddress,
                  int socketTimeout,
                  ReplicationNetworkConfig netConfig) {
        this(nodeName, groupName, socketAddress,
                        socketTimeout, initializeFactory(netConfig, nodeName));
    ...
    public DbPing(ReplicationNode repNode,
        ...
        this(repNode.getName(), groupName,
                        repNode.getSocketAddress(),
                        socketTimeout, channelFactory);
    }

    private DbPing (String nodeName,
                    String groupName,
                    InetSocketAddress socketAddress,
                    int socketTimeout,
                    DataChannelFactory channelFactory) {
