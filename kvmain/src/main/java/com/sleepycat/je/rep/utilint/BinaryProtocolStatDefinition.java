...
public class BinaryProtocolStatDefinition {
    ...
    public static final String N_READ_NANOS_DESC =
        "The total nanoseconds spent reading from the network channel.";
    ...
    public static final String N_WRITE_NANOS_DESC =
        "The total nanoseconds spent writing to the network channel.";
    public static final StatDefinition N_WRITE_NANOS =
        new StatDefinition(
            N_WRITE_NANOS_NAME,
            N_WRITE_NANOS_DESC);

    public static final String N_MAX_WRITE_NANOS_NAME = "nMaxWriteNanos";
    public static final String N_MAX_WRITE_NANOS_DESC =
        "The max nanoseconds for a single write operation on the " +
        "network channel.";
    public static final StatDefinition N_MAX_WRITE_NANOS =
        new StatDefinition(N_MAX_WRITE_NANOS_NAME, N_MAX_WRITE_NANOS_DESC);

    public static final String WRITE_AVG_NANOS_NAME = "writeAvgNanos";
    public static final String WRITE_AVG_NANOS_DESC =
        "The avg nanos for a single write operation on the network channel.";
    public static final StatDefinition WRITE_AVG_NANOS =
        new StatDefinition(WRITE_AVG_NANOS_NAME, WRITE_AVG_NANOS_DESC);

    /* Note that the %ile latencies are in ms (unlike the avg and max above) so
     * that the can be easily bounded, and since only latencies >= 1ms are of
     * interest from this point of view.
     */
    public static final String WRITE_95_MS_NAME = "write95Ms";
    public static final String WRITE_95_MS_DESC =
        "The 95 percentile ms for write operations on the network channel.";
    public static final StatDefinition WRITE_95_MS =
        new StatDefinition(WRITE_95_MS_NAME, WRITE_95_MS_DESC);

    public static final String WRITE_99_MS_NAME = "write99Ms";
    public static final String WRITE_99_MS_DESC =
        "The 99 percentile ms for write operations on the network channel.";
    public static final StatDefinition WRITE_99_MS =
        new StatDefinition(WRITE_99_MS_NAME, WRITE_99_MS_DESC);
    ...
    public static final String WRITE_AVG_BYTES_NAME = "writeAvgBytes";
    public static final String WRITE_AVG_BYTES_DESC =
        "The avg bytes written in a single write operation " +
        "on the network channel.";
    public static final StatDefinition WRITE_AVG_BYTES =
        new StatDefinition(WRITE_AVG_BYTES_NAME, WRITE_AVG_BYTES_DESC);
