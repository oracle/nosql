...
public class ReplicationSSLConfig extends ReplicationNetworkConfig {
     ...
     *   {@link #SSL_NEED_CLIENT_AUTH je.rep.ssl.needClientAuth}
    ...
    /**
     * The path to the Java keystore file for SSL data channel factories.
     ...
     * <p><table border="1">
     * <caption>Information about configuration option</caption>
    ...
    /**
     * The password for accessing the Java keystore file for SSL data channel
    ...
    /**
     * A string encoding the parameters for configuring the keystore password
     * class.
     * <p><table border="1">
     * <caption>Information about configuration option</caption>
     * <tr><td>Name</td><td>Type</td><td>Mutable</td><td>Default</td></tr>
    ...
    public static final String SSL_NEED_CLIENT_AUTH =
        EnvironmentParams.REP_PARAM_PREFIX + "ssl.needClientAuth";
    ...
    /**
     * The password for accessing the Java truststore file for SSL data channel
     * factories. If this parameter is not set or has an empty value, the Java
    ...
    /**
     * A class that will be instantiated in order to retrieve a password that
     * allows access to the truststore file. The class must implement the
     * <code>com.sleepycat.je.rep.net.PasswordSource</code> interface.
     * <p><table border="1">
     * <caption>Information about configuration option</caption>
     * <tr><td>Name</td><td>Type</td><td>Mutable</td><td>Default</td></tr>
     ...
     * </table>
     */
    public static final String SSL_TRUSTSTORE_PASSWORD_CLASS =
        EnvironmentParams.REP_PARAM_PREFIX + "ssl.trustStorePasswordClass";

    /**
     * A string encoding the parameters for configuring the truststore password
     * class.
     * <p><table border="1">
     * <caption>Information about configuration option</caption>
     * <tr><td>Name</td><td>Type</td><td>Mutable</td><td>Default</td></tr>
     ...
     * </table>
     */
    public static final String SSL_TRUSTSTORE_PASSWORD_PARAMS =
        EnvironmentParams.REP_PARAM_PREFIX + "ssl.trustStorePasswordParams";
    ...
    static {
        ...
        repSSLProperties.add(SSL_NEED_CLIENT_AUTH);
        repSSLProperties.add(SSL_TRUSTSTORE_FILE);
        repSSLProperties.add(SSL_TRUSTSTORE_PASSWORD);
        repSSLProperties.add(SSL_TRUSTSTORE_PASSWORD_CLASS);
        repSSLProperties.add(SSL_TRUSTSTORE_PASSWORD_PARAMS);
    ...
    /* The possibly null password source for truststore access */
    private transient PasswordSource sslTrustStorePasswordSource;
    ...
    /**
     * Returns whether client authentication is required for SSL connections.
     *
     * @return whether client authentication is required
     */
    public boolean getNeedClientAuth() {
        return Boolean.valueOf(
            DbConfigManager.getVal(props, RepParams.SSL_NEED_CLIENT_AUTH));
    }
    ...
    public ReplicationNetworkConfig setSSLTrustStorePassword(String password) {
        ...
        DbConfigManager.setVal(props, RepParams.SSL_TRUSTSTORE_PASSWORD,
                               password, validateParams);
        return this;
    }

    /**
     * Returns the name of a class that should be instantiated to retrieve the
     * password for the Java TrustStore file.
     *
     * @return the TrustStore password source class name
     */
    public String getSSLTrustStorePasswordClass() {

        return DbConfigManager.getVal(props,
                                      RepParams.SSL_TRUSTSTORE_PASSWORD_CLASS);
    }
     ...
     * @return this
     */
    public ReplicationNetworkConfig setSSLTrustStorePasswordClass(
        String className) {

        DbConfigManager.setVal(props, RepParams.SSL_TRUSTSTORE_PASSWORD_CLASS,
                               className, validateParams);
        return this;
    }

    /**
     * Returns a string to be used in the constructor for a truststore password
     * source instance.
     *
     * @return the parameter values
     */
    public String getSSLTrustStorePasswordParams() {

        return DbConfigManager.getVal(props,
                                      RepParams.SSL_TRUSTSTORE_PASSWORD_PARAMS);
    }

    /**
     * Sets the string to be used in the constructor for a truststore password
     * source instance.
     *
     * @param params a string that is to be passed to the constructor
     *
     * @return this
     */
    public ReplicationNetworkConfig setSSLTrustStorePasswordParams(
        String params) {

        DbConfigManager.setVal(props, RepParams.SSL_TRUSTSTORE_PASSWORD_PARAMS,
                               params, validateParams);
        return this;
    }
    ...
    /**
     * Gets the password source provided for TrustStore access by the SSL
     * implementation.
     */
    public PasswordSource getSSLTrustStorePasswordSource() {
        return sslTrustStorePasswordSource;
    }

    /**
     * Sets the password source for TrustStore access by the SSL implementation.
     * If not set to a non-empty value, the SSL implementation uses the
     * {@link #SSL_TRUSTSTORE_PASSWORD je.rep.ssl.trustStorePassword}
     * property instead.
     * This setting is not included in the serialized representation.
     */
    public ReplicationNetworkConfig
        setSSLTrustStorePasswordSource(PasswordSource passwordSource) {

        sslTrustStorePasswordSource = passwordSource;
        return this;
    }
