...
public class GroupShutdownException extends EnvironmentFailureException {
    ...
    private final long shutdownVLSN;
     ...
     */
    @Override
    public GroupShutdownException wrapSelf(
        String msg, EnvironmentFailureException clonedCause) {
        return new GroupShutdownException(
            msg, (GroupShutdownException) clonedCause);
    }
