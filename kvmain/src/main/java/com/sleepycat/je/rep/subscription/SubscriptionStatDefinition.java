 ...
 */
public class SubscriptionStatDefinition {
    ...
    public static final StatDefinition SUB_HEARTBEAT_SENT =
            new StatDefinition(
                "heartbeats_sent",
                "The number of heartbeats sent to the feeder ");

    public static final StatDefinition SUB_HEARTBEAT_RECEIVED =
            new StatDefinition(
                "heartbeats_received",
                "The number of heartbeats received from feeder ");
}
