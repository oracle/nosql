...
/**
 * This exception may be thrown by a Replica during the <a
...
public class RollbackProhibitedException extends RestartRequiredException {
    ...
    private static String makeMessage(String nodeName,
                                      ...
                                      int rollbackTxnLimit,
                                      boolean rollbackDisabled) {
        long fileNumber = DbLsn.getFileNumber(searchResults.getTruncateLSN());
        long fileOffset = DbLsn.getFileOffset(searchResults.getTruncateLSN());
     ...
     */
    private RollbackProhibitedException(String message,
     ...
     */
    @Override
    public RollbackProhibitedException wrapSelf(
        String msg,
        EnvironmentFailureException clonedCause) {

        return new RollbackProhibitedException(
            msg, (RollbackProhibitedException) clonedCause);
    }
    ...
    public long getTruncationFileNumber() {
        return DbLsn.getFileNumber(searchResults.getTruncateLSN());
    }
    ...
    public long getTruncationFileOffset() {
        return DbLsn.getFileOffset(searchResults.getTruncateLSN());
    }
