...
public class DiffRecordAnalyzer {
     ...
     */
    private static long getVLSN(Cursor cursor, LogManager logManager)
        throws Exception {
        ...
        WholeEntry entry = logManager.getLogEntryAllowInvisible(lsn, -1);

        long vlsn = entry.getHeader().getVLSN();
