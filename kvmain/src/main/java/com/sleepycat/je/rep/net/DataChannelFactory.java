...
public interface DataChannelFactory {
    ...
    public class ConnectOptions {
        ...
        private boolean disableOpeningPort = false;
        ...
        /**
         * Sets the disableOpeningPort option for the connection.
         *
         * @param disable if true, disable opening tcp/ip port
         * @return this instance
         */
        public final ConnectOptions setDisableOpeningPort(boolean disable) {
            this.disableOpeningPort = disable;
            return this;
        }

        /**
         * Gets the disableOpeningPort option for the connection.
         *
         * @return the disableOpeningPort configuration setting
         */
        public final boolean getDisableOpeningPort() {
            return this.disableOpeningPort;
        }
        /**
     ...
     *
     * @param addr The remote address to which the connection should be made.
     *        It is possible for a DataChannelFactory implementation to
     *        proxy this connection through an intermediary.
     * @param localAddr the local address the socket will be bound to. A null
     * value leaves the choice open to the OS.
