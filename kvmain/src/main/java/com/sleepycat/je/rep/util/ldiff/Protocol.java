...
public class Protocol extends BinaryProtocol {
    ...
    public static final Class<? extends Message>
        DB_BLOCKS_CLASS = DbBlocks.class;
    public final MessageOp DB_BLOCKS =
        new MessageOp((short) 1, DbBlocks.class, (ByteBuffer buffer)->{
            return new DbBlocks(buffer);
        });

    public final MessageOp DB_MISMATCH =
        new MessageOp((short) 2, DbMismatch.class, (ByteBuffer buffer)->{
            return new DbMismatch(buffer);
        });

    public final MessageOp BLOCK_LIST_START =
        new MessageOp((short) 3, BlockListStart.class, (ByteBuffer buffer)->{
            return new BlockListStart(buffer);
        });

    public final MessageOp BLOCK_INFO =
        new MessageOp((short) 4, BlockInfo.class, (ByteBuffer buffer)->{
            return new BlockInfo(buffer);
        });

    public static final Class<? extends Message>
        BLOCK_LIST_END_CLASS = BlockListEnd.class;
    public final MessageOp BLOCK_LIST_END =
        new MessageOp((short) 5, BlockListEnd.class, (ByteBuffer buffer)->{
            return new BlockListEnd(buffer);
        });

    public static final Class<? extends Message> ENV_DIFF_CLASS = EnvDiff.class;
    public final MessageOp ENV_DIFF =
        new MessageOp((short) 6, EnvDiff.class, (ByteBuffer buffer)->{
            return new EnvDiff(buffer);
        });

    public final MessageOp ENV_INFO =
        new MessageOp((short) 7, EnvInfo.class, (ByteBuffer buffer)->{
            return new EnvInfo(buffer);
        });

    public static final Class<? extends Message>
        REMOTE_DIFF_REQUEST_CLASS = RemoteDiffRequest.class;
    public final MessageOp REMOTE_DIFF_REQUEST =
        new MessageOp((short) 8, RemoteDiffRequest.class,
            (ByteBuffer buffer)->{ return new RemoteDiffRequest(buffer);
        });

    public final MessageOp REMOTE_RECORD =
        new MessageOp((short) 9, RemoteRecord.class, (ByteBuffer buffer)->{
            return new RemoteRecord(buffer);
        });

    public static final Class<? extends Message>
        DIFF_AREA_START_CLASS = DiffAreaStart.class;
    public final MessageOp DIFF_AREA_START =
        new MessageOp((short) 10, DiffAreaStart.class, (ByteBuffer buffer)->{
            return new DiffAreaStart(buffer);
        });

    public static final Class<? extends Message>
        DIFF_AREA_END_CLASS = DiffAreaEnd.class;
    public final MessageOp DIFF_AREA_END =
        new MessageOp((short) 11, DiffAreaEnd.class, (ByteBuffer buffer)->{
            return new DiffAreaEnd(buffer);
        });

    public static final Class<? extends Message> DONE_CLASS = Done.class;
    public final MessageOp DONE =
        new MessageOp((short) 12, Done.class, (ByteBuffer buffer) -> {
            return new Done(buffer);
        });

    public static final Class<? extends Message> ERROR_CLASS = Error.class;
    public final MessageOp ERROR =
        new MessageOp((short) 13, Error.class, (ByteBuffer buffer)->{
    ...
    public Protocol(NameIdPair nameIdPair, EnvironmentImpl envImpl) {
         ...
         */
        super(nameIdPair, VERSION, envImpl);
    ...
    public class BlockInfo extends SimpleMessage {
        ...
        public BlockInfo(ByteBuffer buffer) {
            ...
            block.setSHA256Hash(getByteArray(buffer));
        ...
        public ByteBuffer wireFormat() {
            return wireFormat(block.getBlockId(), block.getBeginKey(),
                              block.getBeginData(), block.getSHA256Hash(),
