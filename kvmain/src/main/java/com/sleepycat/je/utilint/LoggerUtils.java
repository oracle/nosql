 ...
 */
public class LoggerUtils extends CommonLoggerUtils {
    ...
    public static <T> void logMsg(RateLimitingLogger<T> useLogger,
                                  EnvironmentImpl envImpl,
                                  T object,
                                  Level logLevel,
                                  String msg) {
    ...
    public static void logMsg(Logger useLogger,
        ...
        try {
            useLogger.log(logLevel, supplier);
        } finally {
            /* Clear thread specific context. */
            envMap.remove(Thread.currentThread());
        }
    ...
    public static <T> void logMsg(RateLimitingLogger<T> useLogger,
        ...
        try {
            useLogger.log(object, logLevel, supplier);
        } finally {
            /* Clear thread specific context. */
            envMap.remove(Thread.currentThread());
        }
    ...
    public static <T> void logMsg(RateLimitingLogger<T> useLogger,
                                  ...
                                  String msg) {
        if (envImpl != null) {
            logMsg(useLogger, envImpl, object, logLevel, msg);
        } else {
            logMsg(useLogger, formatter, object, logLevel, msg);
        }
    }
    ...
    public static void logMsg(Logger useLogger,
                              ...
                              Supplier<String> supplier) {
        if (envImpl != null) {
            logMsg(useLogger, envImpl, logLevel, supplier);
        } else {
            logMsg(useLogger, formatter, logLevel, supplier);
        }
    }

    public static <T> void logMsg(Logger useLogger,
                                  EnvironmentImpl envImpl,
                                  Formatter formatter,
                                  T object,
                                  Level logLevel,
    ...
    public static <T> void severe(RateLimitingLogger<T> useLogger,
                                  EnvironmentImpl envImpl,
                                  T object,
                                  String msg) {
        logMsg(useLogger, envImpl, object, Level.SEVERE, msg);
    }
    ...
    public static <T> void warning(RateLimitingLogger<T> useLogger,
                                   EnvironmentImpl envImpl,
                                   T object,
                                   String msg) {
        logMsg(useLogger, envImpl, object, Level.WARNING, msg);
    }
    ...
    public static <T> void info(RateLimitingLogger<T> useLogger,
                                EnvironmentImpl envImpl,
                                T object,
                                String msg) {
        logMsg(useLogger, envImpl, object, Level.INFO, msg);
    }
    ...
    public static <T> void fine(RateLimitingLogger<T> useLogger,
                                EnvironmentImpl envImpl,
                                T object,
                                String msg) {
        logMsg(useLogger, envImpl, object, Level.FINE, msg);
    }

    public static void fine(Logger useLogger,
                            EnvironmentImpl envImpl,
                            Supplier<String> supplier) {
        logMsg(useLogger, envImpl, Level.FINE, supplier);
    }
    ...
    public static <T> void finer(RateLimitingLogger<T> useLogger,
                                 EnvironmentImpl envImpl,
                                 T object,
                                 String msg) {
        logMsg(useLogger, envImpl, object, Level.FINER, msg);
    }

    public static void finer(Logger useLogger,
                             EnvironmentImpl envImpl,
                             Supplier<String> supplier) {
        logMsg(useLogger, envImpl, Level.FINER, supplier);
    }
    ...
    public static <T> void finest(RateLimitingLogger<T> useLogger,
                                  EnvironmentImpl envImpl,
                                  T object,
                                  String msg) {
        logMsg(useLogger, envImpl, object, Level.FINEST, msg);
    }

    public static void finest(Logger useLogger,
                              EnvironmentImpl envImpl,
                              Supplier<String> supplier) {
        logMsg(useLogger, envImpl, Level.FINEST, supplier);
    }
    ...
    public static void fullThreadDump(Logger logger,
        ...
        synchronized (fullThreadDumpMutex) {
            ...
            /*
             * TODO: This should be one log message with new lines - Use a
             *  StringBuilder instead of logging each line, says Aditya.
             */
