...
public class ReplicationContext {
     ...
     * levels.
     */
    public ReplicationContext(long clientVLSN) {
     ...
     */
    public ReplicationContext(long clientVLSN, boolean inReplicationStream) {
        this.clientVLSN = clientVLSN;
        this.inReplicationStream = inReplicationStream;
    }
    ...
    public boolean mustGenerateVLSN() {
        return (inReplicationStream && (clientVLSN == INVALID_VLSN));
    }
