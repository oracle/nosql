 ...
 * output. This is used to analyze log cleaner behavior.
 *
 * ... 3 files
...
public class VLSNDistributionReader extends DumpFileReader {
    ...
    private class PerFileInfo {
        ...
        private long firstVLSNInFile;
        private long lastVLSNInFile;
        private int count;
        ...
        void increment(long currentVLSN) {
            count++;
            if (firstVLSNInFile == INVALID_VLSN) {
