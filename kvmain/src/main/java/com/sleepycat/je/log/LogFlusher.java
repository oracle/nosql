...
import static com.sleepycat.je.utilint.JETaskCoordinator.JE_LOG_FLUSHER_ASYNC_TASK;
import static com.sleepycat.je.utilint.JETaskCoordinator.JE_LOG_FLUSHER_SYNC_TASK;
...
import com.sleepycat.je.utilint.TaskCoordinator.Task;
...
public class LogFlusher {
    ...
    static class FlushTask extends TimerTask {
        ...
        public void run() {
            ...
            final Task task = (fsync ?
                JE_LOG_FLUSHER_SYNC_TASK : JE_LOG_FLUSHER_ASYNC_TASK);

            try (Permit permit = envImpl.getTaskCoordinator().acquirePermit(
                    task, PERMIT_WAIT_MS, PERMIT_TIME_TO_HOLD_MS,
