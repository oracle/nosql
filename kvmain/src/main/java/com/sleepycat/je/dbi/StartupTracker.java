...
public class StartupTracker {
    ...
    public enum Phase {
        ...
        static {
            ...
            BUILD_TXNID_STATUS_MAPS.root = TOTAL_ENV_OPEN;
            ...
            RESTORE_ELECTION_STATE.root = TOTAL_JOIN_GROUP;
    ...
    public StartupTracker(EnvironmentImpl envImpl) {
        ...
        lastDumpMillis = TimeSupplier.currentTimeMillis();
    }
    ...
    public void stop(Phase phase) {
         ...
         */
         if ((TimeSupplier.currentTimeMillis() - lastDumpMillis) > dumpThreshold) {
             ByteArrayOutputStream baos = new ByteArrayOutputStream();
             PrintStream p = new PrintStream(baos);
    ...
    static private class Elapsed {
        ...
        private void start() {
            start = TimeSupplier.currentTimeMillis();
        }

        /* Mark the end of a phase. */
        private void end() {
            end = TimeSupplier.currentTimeMillis();
        }
