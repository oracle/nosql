...
public class DatabaseId extends BasicVersionedWriteLoggable
    ...
    public static DatabaseId fromBytes(final byte[] bytes) {
        return fromString(StringUtils.fromUTF8(bytes));
    }

    private static DatabaseId fromString(String s) {
        return new DatabaseId(Long.parseLong(s));
    }
