 ...
 *   evict calls preload, then evictMemory
...
public class DbRunAction {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            recoveryStart = TimeSupplier.currentTimeMillis();
            ...
            actionStart = TimeSupplier.currentTimeMillis();
            switch(doAction) {
            case BATCH_CLEAN:
            ...
            actionEnd = TimeSupplier.currentTimeMillis();
    ...
    private static void removeAndClean(Environment env,
        ...
        a = TimeSupplier.currentTimeMillis();
        env.removeDatabase(txn, name);
        c = TimeSupplier.currentTimeMillis();
        ...
        d = TimeSupplier.currentTimeMillis();

        System.out.println("cleanedCount=" + cleanedCount);
        e = 0;
        f = 0;
        if (cleanedCount > 0) {
            e = TimeSupplier.currentTimeMillis();
            env.checkpoint(force);
            f = TimeSupplier.currentTimeMillis();
        }
