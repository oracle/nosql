 ...
 * Every time T locks a new LSN of R, it creates a new WriteLockIno. However,
...
public class WriteLockInfo {
    ...
    public void setAbortModificationTime(long v) {
    ...
    public void setAbortTombstone(boolean v) {
        abortTombstone = v;
    }
