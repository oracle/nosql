...
public class UndoReader {
    ...
    public static UndoReader create(
        ...
        /*
         * LastLoggedSize param is -1 meaning we'll have to do two fetches.
         * This is OK because undo is infrequent.
         */
        final WholeEntry wholeEntry = envImpl.getLogManager().
            getWholeLogEntryHandleNotFound(undoLsn, -1);
        ...
        return new UndoReader(logEntry, ln, undoLsn, logEntrySize, db);
    }
