 ...
 * <div>
 * <table border="1">
 *  <caption>Information about relationships</caption>
...
public interface SecondaryMultiKeyCreator {
     ...
     *
     * @param expirationTime the expiration time of the record. It is
     * needed only if the secondary index indexes the expiration time.
     *
     * @param storageSize the storage size of the record. It is
     * needed only if the secondary index indexes the storage size.
     *
