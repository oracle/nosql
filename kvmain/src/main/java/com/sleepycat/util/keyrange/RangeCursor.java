...
public class RangeCursor implements Cloneable {
     ...
     * performed, and JE does not prevent insertions in other threads. Without
     * the restarts, getLast could return NOTFOUND when keys in the range
     * exist. This may only be an issue for JE since it uses record locking,
     * while DB core uses page locking.
     */
