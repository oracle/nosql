 ...
 *    kv/kvmain/src/main/resources/messages.properties.
 * 2. Run mvn compile, this will produce the file
 *    kv/kvmain/target/generated-sources/annotations/oracle/kv/util/ErrorMessage.java.
...
public class MessageFileProcessor {
    ...
    private static final String PATH_TO_SRC = "src" + FILE_SEP + "main" +
    FILE_SEP + "java";
    private static final String PATH_TO_RESOURCES = "src" + FILE_SEP + "main" +
    FILE_SEP + "resources";
    ...
    private static final String PATH_TO_MESSAGE_FILE = FILE_SEP +
        PATH_TO_RESOURCES + FILE_SEP + MESSAGES_FILE_NAME;
    private static final String PATH_TO_GENERATED_JAVA_CLASS = FILE_SEP +
        PATH_TO_SRC + FILE_SEP + "oracle" + FILE_SEP + "kv" + FILE_SEP +
    ...
    private static void
         ...
         * nothing.
         */
        File src = new File(generatedEnumSrcFilePath);
        if (src.lastModified() >
