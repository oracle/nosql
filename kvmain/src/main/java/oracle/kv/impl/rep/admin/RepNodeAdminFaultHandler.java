...
public class RepNodeAdminFaultHandler extends ServiceFaultHandler {
    ...
    /** Constructor without service, for testing */
    public RepNodeAdminFaultHandler(Logger logger,
                                    ProcessExitCode defaultExitCode) {
    ...
    protected RuntimeException getThrowException(RuntimeException fault) {
        ...
        /*
         * Throttling exceptions are passed through. At this time, this will
         * only happen if a getTable() call on RepNodeAdmin with a non-zero
         * cost is throttled.
         */
        if (fault instanceof ResourceLimitException) {
            return fault;
        }
    ...
    public ProcessExitCode getExitCode(RuntimeException requestException) {
        ...
        return (requestException instanceof InsufficientLogException) ?
            null : super.getExitCode(requestException);
    }
