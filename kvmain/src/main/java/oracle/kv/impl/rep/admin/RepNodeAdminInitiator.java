...
/**
 * A client-side implementation of RepNodeAdmin using async.
 */
public class RepNodeAdminInitiator {

    public static RepNodeAdmin createProxy(CreatorEndpoint endpoint,
                                           DialogType dialogType,
                                           long timeoutMs,
                                           Logger logger) {
        return JavaSerialInitiatorProxy.createProxy(
            RepNodeAdmin.class, REP_NODE_ADMIN_TYPE_FAMILY, endpoint,
