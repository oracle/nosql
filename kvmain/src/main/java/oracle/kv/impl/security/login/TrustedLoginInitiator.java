...
/**
 * A client-side implementation of TrustedLogin using async.
 */
public class TrustedLoginInitiator {

    public static TrustedLogin createProxy(CreatorEndpoint endpoint,
                                           DialogType dialogType,
                                           long timeoutMs,
                                           Logger logger) {
        return JavaSerialInitiatorProxy.createProxy(
            TrustedLogin.class, TRUSTED_LOGIN_TYPE_FAMILY, endpoint,
