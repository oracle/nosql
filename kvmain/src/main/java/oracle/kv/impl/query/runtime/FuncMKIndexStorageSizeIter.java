...
public class FuncMKIndexStorageSizeIter extends PlanIter {
    ...
    public boolean next(RuntimeControlBlock rcb) {
        ...
        if (row.isTuple()) {
            ...
            storageSize = row.asJsonRowMap().getIndexStorageSize();
    ...
    public boolean equals(Object obj) {
        ...
        if (!super.equals(obj) ||
            !(obj instanceof FuncMKIndexStorageSizeIter)) {
            return false;
        }
        final FuncMKIndexStorageSizeIter other =
            (FuncMKIndexStorageSizeIter) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), theInput, theIndexName);
    }
}
