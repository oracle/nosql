...
/**
 * Function to return the remaining life of a row in days
 */
public class FuncRemainingDays extends Function {

    FuncRemainingDays() {
        super(FuncCode.FN_REMAINING_DAYS, "remaining_days",
    ...
    Expr normalizeCall(ExprFuncCall funcCall) {
        ...
        throw new QueryException(
            "The argument to the remaining_days function must " +
    ...
    PlanIter codegen(CodeGenerator codegen,
        ...
        return new FuncRemainingDaysIter(caller, resultReg, argIters[0]);
    }
}
