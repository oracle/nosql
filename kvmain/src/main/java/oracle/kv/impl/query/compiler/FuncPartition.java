...
import oracle.kv.impl.query.runtime.FuncPartitionIter;
import oracle.kv.impl.query.types.TypeManager;

/**
 * Function to return the last modicifation time of the current row
 */
public class FuncPartition extends Function {

    FuncPartition() {
        super(FuncCode.FN_PARTITION, "partition",
    ...
    Expr normalizeCall(ExprFuncCall funcCall) {
        ...
        throw new QueryException(
            "The argument to the partition function must " +
    ...
    PlanIter codegen(
        ...
        return new FuncPartitionIter(caller, resultReg, argIters[0]);
    }
}
