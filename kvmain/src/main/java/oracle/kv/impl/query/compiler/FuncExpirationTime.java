...
public class FuncExpirationTime extends Function {
    ...
    FuncExpirationTime() {
        super(FuncCode.FN_EXPIRATION_TIME, "expiration_time",
    ...
    Expr normalizeCall(ExprFuncCall funcCall) {
        ...
        throw new QueryException(
            "The argument to the expiration_time function must be a row " +
    ...
    PlanIter codegen(CodeGenerator codegen,
        ...
        return new FuncExpirationTimeIter(caller, resultReg, argIters[0]);
    }
}
