...
public class KVQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "VARNAME", "ACCOUNT", "ADD", "ADMIN", 
			"ALL", "ALTER", "ALWAYS", "ANCESTORS", "AND", "AS", "ASC", "ARRAY_COLLECT", 
			...
			"UNICODE", "CLEAR", "CURRENT", "EXPIRE", "EXTERNALLY", "PREFER", "PRIVILEGES", 
			"RETAIN", "RETAINED"
		};
	}
