...
public class SkipParser extends Parser {
    ...
    /**
     * Skips data by calling <code>skipXyz</code> or <code>readXyz</code>
     * methods on <code>this</code>, until the parser stack reaches the target
     * level.
     */
    protected final void skipTo(int target) throws IOException {
     ...
     * 
     * @param symToSkip
     *            The symbol that should be skipped.
     */
