...
package oracle.kv.impl.api.table.serialize.util;

import java.nio.charset.Charset;

import oracle.kv.impl.api.table.serialize.BinaryData;
...
public class Utf8 implements Comparable<Utf8>, CharSequence {
    ...
    private static final Utf8Converter UTF8_CONVERTER = System
            .getProperty("java.version").startsWith("1.6.")
