...
public class PutIfPresent extends Put {
    ...
    private PutIfPresent(PutIfPresent other, short serialVersion) {
    ...
    @Override
    public PutIfPresent deserializedForm(short serialVersion) {
        return new PutIfPresent(this, serialVersion);
    }
}
