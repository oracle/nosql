...
/**
 * A client-side implementation of RemoteTestInterfaceInitiator using async.
 */
public class RemoteTestInterfaceInitiator {

    public static
        RemoteTestInterface createProxy(CreatorEndpoint endpoint,
                                        DialogType dialogType,
                                        long timeoutMs,
                                        Logger logger) {
        return JavaSerialInitiatorProxy.createProxy(
            RemoteTestInterface.class, REMOTE_TEST_INTERFACE_TYPE_FAMILY,
