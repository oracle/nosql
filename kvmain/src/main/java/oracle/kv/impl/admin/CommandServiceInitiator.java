...
/**
 * A client-side implementation of CommandService using async.
 */
public class CommandServiceInitiator {

    public static CommandService createProxy(CreatorEndpoint endpoint,
                                             DialogType dialogType,
                                             long timeoutMs,
                                             Logger logger) {
        return JavaSerialInitiatorProxy.createProxy(
            CommandService.class, COMMAND_SERVICE_TYPE_FAMILY, endpoint,
