...
/**
 * This exception is thrown when error occurs while calling {@link
 * DialogContext#read} and {@link DialogContext#write}.
 */
public abstract class ContextException extends RuntimeException
     ...
     */
    protected ContextException(String message, Throwable cause) {
        super(message, cause);
    }
}
