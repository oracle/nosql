...
select
 ...
 trunc(power(-0, 100000000000000000000000000),3) as power_neg0_100E24,
 trunc(power(0, 100000000000000000000000000),3) as power_0_100E24,
 trunc(power(100000000000000000000000000,-0),3) as power_100E24_neg0,
 trunc(power(100000000000000000000000000,0),3) as power_100E24_0,
 ...
 trunc(power(-0, -100000000000000000000000000),3) as power_neg0_neg100E24,
 trunc(power(0, -100000000000000000000000000),3) as power_0_neg100E24,
 trunc(power(-100000000000000000000000000,-0),3) as power_neg100E24_neg0,
 trunc(power(-100000000000000000000000000,0),3) as power_neg100E24_0,
