#cos of min and boundary values
...
trunc(t.doc.pi1,7) as jsonpi1, trunc(cos(t.doc.pi1),7) as cosjsonpi1,
trunc(t.doc.pi2,7) as jsonpi2, trunc(cos(t.doc.pi2),7) as cosjsonpi2,
trunc(t.doc.pi3,7) as jsonpi3, trunc(cos(t.doc.pi3),7) as cosjsonpi3
