...
{
"query file" : "inner_joins/q/q19.q",
"plan" : 
{
    ...
    "input iterator" :
    {
      ...
      "FROM" :
      {
        ...
        "join predicates" : [
          ...
          { "outerBranch" :0, "outerExpr" : 2, "innerVar" : 3 }
        ],
        "branches" : [
          {
            "iterator kind" : "SELECT",
          ...
          },
          {
            ...
            "FROM" :
            {
              ...
              "index scans" : [
                {
                  "equality conditions" : {},
                  "range conditions" : { "content.receivers[]" : { "start value" : "", "start inclusive" : false, "end value" : "", "end inclusive" : false } }
                }
              ],
