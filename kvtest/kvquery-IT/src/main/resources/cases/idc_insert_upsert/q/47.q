#TestDescription: upsert with no set ttl clause
#Expected result: ttl does not change

upsert into playerinformation $row1 values (
100,
210,
"upsert with no set ttl clause",
41,
523266,
5230432,
83.5,
