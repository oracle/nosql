...
"plan" : 
{
  ...
  "input iterator" :
  {
    ...
    "indexes to update" : [ "idx1", "idx_anna_areacode", "idx_children_anna_friends", "idx_children_both", "idx_children_values", "idx_kids_anna_friends" ],
    "update clauses" : [
      {
        "iterator kind" : "PUT",
